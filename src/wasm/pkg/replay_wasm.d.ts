 ...
 */
export function analyze_replay(data: Uint8Array, you: string): string;
...
export interface InitOutput {
    ...
    readonly analyze_replay: (a: number, b: number, c: number, d: number) => [number, number, number, number];
    readonly start: () => void;
