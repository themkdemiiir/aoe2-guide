...
steps:
  ...
  - { assign: "Boştaki ekonomi köylüleriyle TC altına 1–3 geyik çek", note: "Bedava et, koyunlar azalırken TC'yi çalışır tutar", icons: ["food", "town-center"] }
  ...
  - { time: "8:50", phase: feudal, villagers: 18, assign: "18 nüfusta Feudal'a tıkla (2 odun / 15 yiyecek / 1 altın)", icons: ["loom"] }
  - { villagers: 18, assign: "TC'den 7 → yeni kütük kampı; 2 → kışla + ev; 2 → ayrık ağaçlar", icons: ["lumber-camp", "barracks", "house", "wood"] }
  - { assign: "2 Okçu Menzili kur; Feudal gelir gelmez ikisinden de Okçu üret", icons: ["archery-range", "archer"] }
  - { villagers: 25, assign: "1 menzil yapan köylü → Demirci; diğeri → yiyecek; 7 köylüyü altına koy", note: "Fletching araştır, sonra Okçuları saldırıya gönder", icons: ["blacksmith", "gold", "fletching"] }
  - { villagers: 31, assign: "+6 → meyveler; av ve meyveler bitince tarla ek", icons: ["food", "farm"] }
  - { villagers: 36, assign: "+2 → odun, sonra +3 → altın; çağ atlamak için Pazar'dan taş sat", icons: ["wood", "gold", "market"] }
