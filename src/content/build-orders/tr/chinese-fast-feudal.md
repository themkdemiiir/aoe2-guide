...
steps:
  - { villagers: 6,  assign: "6 → Town Center altında koyunda; Chinese fazladan başlangıç sayesinde ev kurmayı atla", note: "Loom'u hemen araştır", icons: ["food", "town-center", "loom"] }
  - { villagers: 7,  assign: "+1 → Town Center altında koyunda", icons: ["food"] }
  - { villagers: 10, assign: "+3 → oduna, lumber camp kur", icons: ["wood", "lumber-camp"] }
