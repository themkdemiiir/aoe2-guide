...
steps:
  - { villagers: 5, assign: "5 → TC altındaki koyunlara", icons: ["food", "town-center"] }
  - { villagers: 8, assign: "+3 → tavukların üzerine değirmen kur ve tavukları topla", note: "Tavuklar TC'nin hemen yanında hızlı ve yoğun yiyecek verir", icons: ["mill", "food"] }
  - { villagers: 9, assign: "+1 → tekrar koyunlara", icons: ["food"] }
  - { villagers: 10, assign: "+1 → ilk yaban domuzunu çek ve öldür", icons: ["food"] }
  - { villagers: 11, assign: "+1 → bir ev kur, sonra tek ağaçtan odun kes", icons: ["house", "wood"] }
  - { villagers: 14, assign: "+3 → TC yakınındaki tek ağaçlara", icons: ["wood"] }
  - { villagers: 15, assign: "+1 → ikinci yaban domuzunu çek", icons: ["food"] }
  - { villagers: 15, assign: "Tek ağaçlardaki 4 köylüye odun kampı kur", note: "Yeni köylü yok — sadece düzgün bir ağaç hattına taşı", icons: ["lumber-camp", "wood"] }
  - { villagers: 18, assign: "+3 → TC altındaki ava; Loom araştır, sonra Feudal'a tıkla", time: "8:50", note: "18 nüfusta, 4 odun / 14 yiyecek dağılımıyla geç", icons: ["food", "loom"] }
  - { villagers: 18, assign: "Feudal: 6 köylüyü değirmenle çilek çalılarına götür ki yiyecek akmaya devam etsin", icons: ["food", "mill"] }
  - { villagers: 18, assign: "Feudal açılışını scout'unun gördüğüne göre seç — scout, okçu veya man-at-arms hepsi buradan çalışır", icons: ["scout-cavalry", "archer"] }
source:
  author: "Hera"
