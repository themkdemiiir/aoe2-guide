...
name: "Süvarilerden Atlı Okçulara"
difficulty: intermediate
targetAge: castle
durationMin: 17
civsRecommended: [mongols, huns, magyars, japanese, tatars]
steps:
  - { villagers: 6,  assign: "6 → Şehir Merkezi'nin yanındaki koyunlar", icons: ["food", "town-center"] }
  ...
  - { villagers: 18, assign: "Feudal: 5 → odun + 2. Kereste Kampı; 5 → meyveler; 1 → Kışla kurar", icons: ["wood", "lumber-camp", "food", "barracks"] }
  - { villagers: 18, assign: "2 köylü Ahır kurar; sürekli Süvari üret ve taciz et", note: "Ahır bitince o iki köylüyle üssü duvarla", icons: ["stable", "scout-cavalry"] }
  - { villagers: 18, assign: "Double-Bit Axe araştır; kapalı haritalarda Horse Collar ekle; Tarla kur; düşman süvarisine karşı 1–4 Mızrakçı ekle", icons: ["double-bit-axe", "horse-collar", "farm", "spearman"] }
  - { villagers: 23, assign: "~15 Tarlada 5 → altın + Maden Kampı; Demirci kur; üssü tamamen duvarla", icons: ["gold", "mining-camp", "blacksmith"] }
  - { villagers: 27, assign: "Kapalı duvarın arkasında Castle çağa tıkla", note: "Altın biriktir ve geçiş için Süvarileri hayatta tut", icons: ["food"] }
  - { villagers: 27, assign: "Castle: 2 Okçu Menzili kur; Bloodlines + Fletching araştır; Atlı Okçu üretmeye başla", icons: ["archery-range", "bloodlines", "cavalry-archer"] }
  - { villagers: 27, assign: "Bow Saw, Bodkin Arrow, Husbandry araştır; Kale'de Mangudai'ye yükselt", icons: ["bow-saw", "bodkin-arrow", "husbandry"] }
source:
  author: "Hera"
...
Feudal çağda Süvarilerle harita kontrolünü ele geçir, üssünü güvenle duvarla ve ardından Castle çağda yığınla Atlı Okçuya — Moğollar için Mangudai yükseltmesine — geçiş yap.

## Strateji ve Devamı (Sırada Ne Var)

- Feudal Süvariler asıl kazanma planın değil, bir perdedir: görevleri düşmanın harita kontrolünü engellemek ve sen üssü tamamen duvarlarken zaman kazandırmaktır. Onları Mızrakçı veya Okçulara karşı fazla harcama.
