...
steps:
  ...
  - { assign: "Push the deer toward your TC with the scout", note: "Keeps all hunt close so food never idles", icons: ["food"] }
  - { villagers: 18, time: "8:50", phase: feudal, assign: "+6 → hunt (16 on food, 2 on wood), then click up to Feudal", note: "Aztecs / Incas: research Loom before aging up", icons: ["food", "loom"] }
