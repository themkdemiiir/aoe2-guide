...
steps:
  ...
  - { villagers: 18, assign: "Produce Scout Cavalry; research Double-Bit Axe; begin walling base", icons: ["scout-cavalry", "double-bit-axe"] }
...
**Goal:** Control the map with Scouts in Feudal Age, safely wall your base, and transition to Cavalry Archers in Castle Age.
**Recommended civs:** Huns, Mongols, Magyars, Japanese, Tatars
...
- Research Fletching and Bloodlines
