...
export const ui = {
  en: {
    ...
    "analyzer.row.winnersResearch": "winners by Castle",
    "analyzer.row.winnersOpen": "winners open",
  ...
  tr: {
    ...
    "analyzer.row.winnersResearch": "kazananlarda Kale'ye kadar",
    "analyzer.row.winnersOpen": "kazananların açılışı",
    "analyzer.error.parse":
