...
const AOESTATS_DATA = [
  ...
  { name: "Persians", winRate: 50.92, playRate: 3.9 },
  { name: "Spanish", winRate: 50.83, playRate: 3.27 },
  { name: "Mongols", winRate: 50.7, playRate: 5.65 },
  { name: "Magyars", winRate: 50.49, playRate: 3.31 },
  { name: "Huns", winRate: 50.28, playRate: 2.52 },
  { name: "Franks", winRate: 50.2, playRate: 4.93 },
  ...
  { name: "Teutons", winRate: 49.91, playRate: 2.7 },
  ...
  { name: "Burgundians", winRate: 49.0, playRate: 2.2 },
  ...
  { name: "Chinese", winRate: 48.9, playRate: 2.03 },
  ...
  { name: "Koreans", winRate: 48.8, playRate: 1.9 },
  { name: "Tatars", winRate: 48.56, playRate: 1.3 },
  ...
  { name: "Gurjaras", winRate: 47.2, playRate: 1.02 },
  { name: "Byzantines", winRate: 46.98, playRate: 2.61 },
  { name: "Georgians", winRate: 46.78, playRate: 1.0 },
