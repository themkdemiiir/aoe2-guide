...
//! (`matches`, `match_players`, `replay_events`, `replay_ages`). See each migration module
//! for the exact DDL. Do NOT partition any table here — that is a separate step before the
